# ==========================================================
# IKBR SCALPING BOT | VERSION v1.6.0 P172 | STAGE: ACC
# ==========================================================
    ...
    def recover_broker_ack_pending_trade(self, record_snapshot, broker_reality, reason_label):
        ...
        if broker_reality["broker_real"]:
            ...
            if pending_age is not None and pending_age >= BROKER_ACK_PENDING_TIMEOUT_SECONDS:
                if stage == "TST":
                    stage_timeout_decision = "keep_symbol_locked_tst_broker_real_present"
                elif stage == "ACC":
                    stage_timeout_decision = "keep_symbol_locked_acc_broker_real_present"
                else:
                    stage_timeout_decision = "keep_symbol_locked_prd_broker_real_present"
                logger.warning(
