# ==========================================================
# IKBR SCALPING BOT | VERSION v1.6.0 P177 | STAGE: ACC
# ==========================================================
...
class ScalpingBot:
    ...
    def get_trade_broker_reality(self, record):
        ...
        try:
            self.log_broker_state_read_context(
                broker_call="openTrades+positions+openOrders",
    ...
    def cancel_unacknowledged_bracket_legs(self, trade_id, reason_label):
        with self.trade_analysis_lock:
            record = self.trade_analysis.get(trade_id)
            if record is None:
                return {
        ...
        try:
            self.log_broker_state_read_context(
                broker_call="openTrades+openOrders",
    ...
    def handle_webhook_signal(self, data):
        ...
        if normalized["payload_format"] == "enriched_candidate":
            ...
            if self.is_eurusd_execution_disabled(normalized["symbol"]):
                ...
                return EURUSD_EXECUTION_DISABLED_REASON
